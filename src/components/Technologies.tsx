...
export const TechnologiesComponent = () => {
  ...
  return (
    <div className="relative">
      <div className=" absolute lg:bottom-60 lg:w-full md:bottom-64 flex items-center justify-center text-slate-700 font-serif text-4xl md:text-2xl fadeTopInfinite font-bold" style={{textShadow: "3px 3px 3px rgb(220,240,255)"}}>
        Tech Stack
      </div>
